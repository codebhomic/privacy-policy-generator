...
<textarea class="form-control" rows="15" col="8" id="copy" >
<h2>Privacy Policy for <?php echo $siteName ?></h2>
<p>At <?php echo $siteName ?>, accessible from <?php echo $siteUrl ?>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by <?php echo $siteName ?> and how we use it.</p>
<p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to Contact through email at <b><?php echo $siteEmail ?></b></p>
...
<P>You may consult this list to find the Privacy Policy for each of the advertising partners of <?php echo $siteName ?>. Our Privacy Policy was created with the help of the <a href="http://colearnacademy.com">GDPR Privacy Policy Generator</a></p>
...
<p>
 ...
 <button onclick="copy()" class="btn btn-primary my-3 text-center" >COPY</button>
